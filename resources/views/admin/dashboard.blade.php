                        ...
                        <tr class="border-b border-gray-200 dark:border-gray-700">
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex space-x-2">
                                    ...
                                    <button type="submit" class="ms-4 inline-flex items-center px-4 py-2 bg-red-500 border border-transparent rounded-md font-semibold text-xs uppercase tracking-widest hover:bg-red-600 focus:bg-red-700 active:bg-red-900 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150 text-black">
                                        {{ __('Eliminar') }}
                                    </button>
