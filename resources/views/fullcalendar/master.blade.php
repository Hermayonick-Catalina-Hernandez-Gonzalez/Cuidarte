            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('secretario.crear-cita') }}">
                        ...
                        <div class="mb-4">
                            <label for="time" class="block mb-2 text-sm font-medium text-gray-900">Seleccionar
                                hora:</label>
                            <div class="flex">
                                <input type="time" id="time"
                                    ...
                                    min="09:00" max="18:00" value="09:00" name="hora" required>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventContent: function(arg) {
                    ...
                    italicEl.innerHTML = '<b>' + arg.event.start.toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit'
                    }) + '</b> ' + arg.event.title;
