    ...
    <x-app-layout>
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-6 p-6 rounded-lg shadow"  style="background-color: #3FBBB4;">
                ...
                <div id="services" class="mt-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="{{ route('secretario.medicamentos', ['servicio' => 'Farmarcia']) }}"
                        class="service block bg-white p-6 rounded-lg shadow">
