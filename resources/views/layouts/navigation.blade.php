        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a
                        href="{{ Auth::user()->role === 'Administrador' ? route('admin.dashboard') : (Auth::user()->role === 'Secretario' ? route('secretario.dashboard') : route('dashboard')) }}">
                        <div class="shrink-0 flex items-center">
                            <img src="{{ asset('imagenes/Logotipo.png') }}" alt="Logo"
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if (Auth::user()->role === 'Administrador')
                        ...
                        <x-nav-link href="{{ route('admin.registro-productos') }}" :active="request()->routeIs('admin.registro-productos')"
                            class="text-black">
                    ...
                    @if (Auth::user()->role === 'Secretario')
                        ...
                        <x-nav-link href="{{ route('secretario.registro-productos') }}" :active="request()->routeIs('secretario.pagos')"
                            class="text-black">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-black bg-[#3FBBB4] hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
            ...
            <div class="-me-2 flex items-center sm:hidden">
                <button @click="open = ! open"
                    class="inline-flex items-center justify-center p-2 rounded-md text-black hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out bg-[#3FBBB4]">
...
<style>
    .custom-navbar {
        ...
        border-bottom: 0px solid #3FBBB4;
    }
