            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            <label for="motivo_consulta" class="block font-medium text-sm dark:text-gray-200">Motivo de la consulta</label>
                        ...
                        <div>
                            <label for="notas_padecimiento" class="block font-medium text-sm dark:text-gray-200">Notas de padecimiento</label>
                        ...
                        <div>
                            <label for="signos_vitales" class="block font-medium text-sm dark:text-gray-200">Signos vitales</label>
                            <div class="flex gap-4">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="temperatura"
                                        class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 bg-white text-gray-900 pl-10"
                                        name="temperatura" value="{{ old('temperatura') }}" placeholder="Temperatura (°C)">
                                </div>
                                <div class="relative">
                                ...
                                <div class="relative">
                                    ...
                                    <input id="frecuencia_cardiaca"
                                        class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 bg-white text-gray-900 pl-10"
                                        name="frecuencia_cardiaca" value="{{ old('frecuencia_cardiaca') }}" placeholder="Frecuencia (bpm)">
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label for="diagnostico" class="block font-medium text-sm dark:text-gray-200">Diagnóstico</label>
                            ...
                            <div id="estudios-container" class="flex flex-col gap-4">
                                <div class="flex gap-4 estudio">
                                    <input id="solicitar_estudios"
                                        class="block mt-1 w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 bg-white text-gray-900"
                                        name="solicitar_estudios[]" value="{{ old('solicitar_estudios') }}" placeholder="Estudio">
